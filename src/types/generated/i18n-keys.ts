...
export const translationKeys = [
  'appProxy.page.title',
  'appProxy.page.notice',
  'appProxy.page.argsNotice',
  'appProxy.page.empty',
  'appProxy.page.candidates.ready',
  'appProxy.page.candidates.empty',
  'appProxy.page.dialogs.executable',
  'appProxy.page.form.addTitle',
  'appProxy.page.form.editTitle',
  'appProxy.page.form.name',
  'appProxy.page.form.searchApps',
  'appProxy.page.form.path',
  'appProxy.page.form.args',
  'appProxy.page.form.argsPlaceholder',
  'appProxy.page.form.argsHelp',
  'appProxy.page.form.isolatedBrowser',
  'appProxy.page.form.profilePath',
  'appProxy.page.form.profileHelp',
  'appProxy.page.form.profileCloneHelp',
  'appProxy.page.badges.browser',
  'appProxy.page.badges.isolatedBrowser',
  'appProxy.page.badges.profileSource',
  'appProxy.page.badges.proxied',
  'appProxy.page.actions.choose',
  'appProxy.page.actions.chooseProfile',
  'appProxy.page.actions.cloneProfile',
  'appProxy.page.actions.scan',
  'appProxy.page.actions.refresh',
  'appProxy.page.actions.add',
  'appProxy.page.actions.save',
  'appProxy.page.actions.cancel',
  'appProxy.page.actions.launch',
  'appProxy.page.actions.edit',
  'appProxy.page.actions.delete',
  'appProxy.page.feedback.pathRequired',
  'appProxy.page.feedback.nameRequired',
  'appProxy.page.feedback.added',
  'appProxy.page.feedback.updated',
  'appProxy.page.feedback.deleted',
  'appProxy.page.feedback.launched',
  'appProxy.page.feedback.launchFailed',
  'appProxy.page.feedback.candidatesFailed',
  'appProxy.page.feedback.profilePathRequired',
  'appProxy.page.feedback.profileCloned',
  'appProxy.page.feedback.profileCloneFailed',
  ...
  'layout.components.navigation.tabs.appProxy',
